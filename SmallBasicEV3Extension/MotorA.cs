...
namespace SmallBasicEV3Extension
{
    ...
    public static class MotorA
    {
        ...
        /// <summary>
        /// Set the motor type for port A - Large motor
        /// </summary>
        ...
        /// <summary>
        /// Set the motor type for port A - Medium motor
        /// </summary>
        ...
        /// <summary>
        /// Set motor speed to port A, then start motor.
        /// </summary>
        /// <param name="speed">Speed value from -100 (full reverse) to 100 (full forward)</param>
        ...
        /// <summary>
        /// Set motor power to port A, then start motor.
        /// </summary>
        /// <param name="power">Speed value from -100 (full reverse) to 100 (full forward)</param>
