...
namespace SmallBasicEV3Extension
{
    ...
    {
        /// <summary>
        /// Similar to ReadRawValue, but returns only a first raw value for port 1. Has a high data return rate.
        /// </summary>
        ...
        /// <summary>
        /// Similar to ReadRawValue, but returns only a first raw value for port 3. Has a high data return rate.
        /// </summary>
        /// <returns>First element of a raw sensor reading</returns>
        public static Primitive Raw3()
        {
            int _values = 1;
