...
namespace SmallBasicEV3Extension
{
    ...
    public static class Sensor
    {
        ...
        /// <summary>
        /// Similar to ReadRawValue, but returns only a first raw value. Has a high data return rate.
        /// </summary>
        /// <param name="port">Number of the sensor port</param>
        /// <returns>First element of a raw sensor reading</returns>
        public static Primitive FirstRawValue(Primitive port)
        {
            int layer;
            int no;
            DecodePort(port, out layer, out no);
        ...
        /// </summary>
        /// <returns>First element of a raw sensor reading</returns>
        public static Primitive FirstRawValue2()
        {
            int _values = 1;
