...
namespace SmallBasicEV3Extension
{
    ...
    /// </summary>
    [SmallBasicType]
    public static class MotorC
    {
        /// <summary>
        /// Query the current rotation count of a single motor for port C. 
        ...
        /// <summary>
        /// Query the current speed of a single motor for port C.
        /// Note that this command does not work for motors connected via daisy-chaining.
        /// </summary>
        ...
        /// <summary>
        /// Set the rotation count of motor port C to 0.
        /// </summary>
        ...
        /// <summary>
        /// Sets the direct polarity for motor to port C
        /// </summary>
        ...
        /// <summary>
        /// Stop motor port C. This will also cancel any scheduled movement for this motor.
        ...
        /// <summary>
        /// Set the motor type for port C - Large motor
        /// </summary>
        ...
        /// <summary>
        /// Set the motor type for port C - Medium motor
        /// </summary>
        ...
        /// <summary>
        /// Set motor speed to port C, then start motor.
        /// </summary>
        /// <param name="speed">Speed value from -100 (full reverse) to 100 (full forward)</param>
        ...
        /// <summary>
        /// Set motor power to port C, then start motor.
        /// </summary>
        /// <param name="power">Speed value from -100 (full reverse) to 100 (full forward)</param>
